...
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    try {
      ...
      // Even if emails fail, we still want to return success for the order
      // The order was processed, just email delivery failed
      emailResult = {
        success: false,
        provider: "none",
    ...
    // Return 200 even if email failed - order was still processed
